-- Migration: Add colors jsonb to all section RPC functions
-- This enables color swatches display on product cards

-- Drop and recreate get_last_viewed_products with colors
...
RETURNS TABLE(
  ...
  colors jsonb  -- NEW: Color swatches
)
LANGUAGE plpgsql
SECURITY DEFINER
...
-- Drop and recreate get_similar_products with colors
...
-- Drop and recreate get_vendor_more_products with colors
...
-- Drop and recreate get_section_products with colors
...
-- Drop and recreate get_best_seller_products with colors
...
-- Drop and recreate get_hot_deals_products with colors
...
-- Drop and recreate get_products_by_category with colors
